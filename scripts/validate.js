...
const enableButton = (submitButton) => {
    ...
    submitButton.classList.remove('popup__save_none-active')
}

const disableButton = (submitButton) => {
    submitButton.disabled = true;
    submitButton.classList.add('popup__save_none-active')
}
...
const setEventListeners = (form, inputList, errorClassTemplate, activeErrorClass, activeErrorClassBoarder, submitButton) => {
...
const enableValidation = (config) => {
    ...
    setEventListeners(form, inputList, config.errorClassTemplate, config.activeErrorClass, config.activeErrorClassBoarder, submitButton);
}
